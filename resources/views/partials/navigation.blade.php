<nav class="w-1/6 h-screen bg-white border-r border-slate-200">
    <div class="flex flex-col justify-between h-full">
        <div>
            <div class="h-20 p-4 border-b border-slate-200">
                <a href="/main">
                    <img class="mx-auto h-auto w-auto" src="/img/nfLogo.svg" alt="Workflow">
                </a>
            </div>
            <div class="flex flex-col my-6">
                ...
                <a href="/dashboard" class="my-1 mx-2 flex items-center rounded-md group hover:bg-slate-100 ">
                    ...
                    <div class="ml-1 text-md font-semibold p-1 text-slate-600">
                        Dashboard
                    </div>
                </a>
        ...
        <div class="flex h-20 border-b border-slate-200 bg-white shadow-sm items-center justify-between py-4 px-6 lg:flex-none">
            <div class="items-center">
                <h1 id="user" class="text-xl font-semibold text-slate-700 border-b border-gray-300">{{$user->firstName}} {{$user->lastName}}</h1>
                <h2 id="" class="text-xs font-normal text-slate-400">Zuletzt eingeloggt: 29-03-2022</h2>
            </div>
            <div class="">
